...
let slider_shop = new Swiper('.shop__swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 70,
...
let slider_streamer = new Swiper('.streamers__swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 70,
...
let slider_testimonials = new Swiper('.testimonials__swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 70,
